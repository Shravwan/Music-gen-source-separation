...
from main1.model_violin import ViolinClassifier  # Make sure model.py is in the same folder
...
def get_filepaths(data_dir):
    filepaths = []
    labels = []
    for label, subdir in enumerate(['nonviolin', 'violin']):
...
# Training function
def train(data_dir, model_out='violin_cnn.pth', epochs=10, batch_size=16):
